...
jQuery(document).ready(function(){
	jQuery('#liteaccordion').liteAccordion({
		...
		activateOn: (liteaccordion_setting.activateon == '') ? 'click' : liteaccordion_setting.activateon,	// click or mouseover  
		firstSlide: (liteaccordion_setting.firstslide == '') ? 1 : liteaccordion_setting.firstslide,	// displays slide (n) on page load  
		slideSpeed: (liteaccordion_setting.slidespeed == '') ? 800 : liteaccordion_setting.slidespeed,	// slide animation speed

		autoPlay: (liteaccordion_setting.autoplay == 'true') ? true : false,	// automatically cycle through slides  
		pauseOnHover: (liteaccordion_setting.pauseonhover == 'true') ? true : false,	// pause on hover  
		cycleSpeed: (liteaccordion_setting.cyclespeed == '') ? 6000 : liteaccordion_setting.cyclespeed,	// time between slide cycles  
		easing: (liteaccordion_setting.easing == '') ? 'swing' : liteaccordion_setting.easing,                       // custom easing function  

		theme: 'basic',                        // basic, dark, light, or stitch  
		rounded: (liteaccordion_setting.rounded == 'true') ? true : false,	// square or rounded corners  
