...
jQuery(document).ready(function(){
	jQuery('#cycle').cycle({ 
		fx: (cycle_setting.fx == '') ? 'scrollLeft' : cycle_setting.fx,
		pause: (cycle_setting.pause == '') ? 0 : 1,
		easing: cycle_setting.easing,
		random: (cycle_setting.random == '') ? 0 : 1,
		timeout: (cycle_setting.timeout == '') ? 5000 : cycle_setting.timeout,
		speed: (cycle_setting.speed == '') ? 1000 : cycle_setting.speed,
		sync: (cycle_setting.sync == '') ? 1 : 0,
		next: '#cycle-next',
		prev: '#cycle-prev',
		
		before: (cycle_setting.animation=='true' ? function onBefore(curr, next, opts, fwd) {
		...
		after: (cycle_setting.animation=='true' ? function onAfter(curr, next, opts, fwd) {
