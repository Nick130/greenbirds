...
/* call showcase slider
---------------------------------------- */
jQuery(document).ready(function() {
	jQuery('#showcase').fadeTo(500, 1);
	
	jQuery('#showcase').awShowcase({
		content_width: (showcase_setting.thumbnailsdirection == 'vertical') ? 800 : 940,
		content_height: (showcase_setting.thumbnailsdirection == 'vertical') ? 380 : 290,
		fit_to_parent: false,
		auto: (showcase_setting.auto == 'true') ? true : false,
		interval: (showcase_setting.interval == '') ? 5000 : showcase_setting.interval,
		continuous: true,
		loading: true,
		arrows: false,
		buttons: false,
		btn_numbers: false,
		keybord_keys: (showcase_setting.keybordkeys == 'true') ? true : false,
		mousetrace: false, /* Trace x and y coordinates for the mouse */
		pauseonover: (showcase_setting.pauseonover == 'true') ? true : false,
		stoponclick:true,
		transition: (showcase_setting.transition == '') ? 'hslide' : showcase_setting.transition, /* hslide/vslide/fade */
		transition_delay: (showcase_setting.transitiondelay == '') ? 300 : showcase_setting.transitiondelay,
		transition_speed: (showcase_setting.transitionspeed == '') ? 500 : showcase_setting.transitionspeed,
		show_caption: (showcase_setting.showcaption == '') ? 'onload' : showcase_setting.showcaption, /* onload/onhover/show */
		thumbnails: (showcase_setting.thumbnails == 'true') ? true : false,
		thumbnails_position: (showcase_setting.thumbnailsposition == '') ? 'outside-last' : showcase_setting.thumbnailsposition, /* outside-last/outside-first/inside-last/inside-first */
		thumbnails_direction: (showcase_setting.thumbnailsdirection == '') ? 'horizontal' : showcase_setting.thumbnailsdirection, /* vertical/horizontal */
		thumbnails_slidex: (showcase_setting.thumbnailsslidex == '') ? 0 : showcase_setting.thumbnailsslidex, /* 0 = auto / 1 = slide one thumbnail / 2 = slide two thumbnails / etc. */
