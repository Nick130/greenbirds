...
$bloginfoauthoronoff = get_post_meta($post->ID, 'bloginfoauthoronoff', true);
$bloginfotagonoff = get_post_meta($post->ID, 'bloginfotagonoff', true);
$bloginfocommentonoff = get_post_meta($post->ID, 'bloginfocommentonoff', true);
...
$blogpaginationajax = get_post_meta($post->ID, 'blogpaginationajax', true);
